...
namespace ServerApi.Database
{
    class Connection
    {
        ...
        public static Boolean register_user(string Email)
        {
            try
            {
        ...
        public static Boolean insert_user_ingroup(string user, int id_group)
        {
            connection();
        ...
        public static Boolean insert_own_products(string Description, int id_type, string user)
        {
            connection();
        ...
        public static int select_id_group(string email)
        {
            connection();
        ...
        public static List<Object> select_own_products(int id_type, string user)
        {
        ...
        public static Boolean insert_products(string id, int id_type, string link, string reference, string user, int group, string description)
        {
            try
            {
        ...
        public static Dictionary<string, string> select_recomendations(string user)
        {
